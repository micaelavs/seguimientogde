...
use FMT\Vista;
	...
	$vars_vista['SUBTITULO']	= 'Modificar Pedido Marbetes';
    ...
    $vars_template['FECHA_RECEPCION'] = !empty($temp = $notagde->fecha_recepcion) ? $temp->format('d/m/Y') : $notagde->fecha_recepcion;
    $vars_template['FECHA_VENCIMIENTO'] = !empty($temp = $notagde->fecha_vencimiento) ? $temp->format('d/m/Y') : $notagde->fecha_vencimiento;
