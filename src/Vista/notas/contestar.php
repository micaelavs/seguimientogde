...
use FMT\Vista;
	...
	$vars_vista['SUBTITULO'] = 'Contestar NOTA GDE';
	$vars_template['CONTROL'] = 'Nota GDE:';
	$vars_template['ARTICULO'] = 'la';
	$vars_template['TEXTO_AVISO'] = 'Contestará ';			
	$vars_template['NOMBRE'] = ''.$notagde->nota;
	$vars_template['RESUMEN'] = $notagde->resumen;
	$vars_template['FECHA_ACCION'] = !empty($temp = $notagde->fecha_accion) ? $temp->format('d/m/Y') : $notagde->fecha_accion;
	$vars_template['TEXTO_EXTRA'] = '<br/>Al contestar la misma, podrá visualizarla en el Listado de Notas GDE contestadas';
	...
	$template = (new \FMT\Template(VISTAS_PATH.'/widgets/contestar.html', $vars_template,['CLEAN'=>false]));
